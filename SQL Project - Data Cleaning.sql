...
-- delete from duplicates_cte where row_num > 2
...
-- Standardizing  Data
-- Trim The customer column 
-- select trim(company) from layoff_staging2;
-- select company from layoff_staging2 where company like " _%";
-- select * from layoff_staging2;
-- update layoff_staging2 
-- set company = trim(company);
-- select * from layoff_staging2;
-- select * from layoff_staging2 where company like 'Crypto%';
...
-- WHERE t1.industry IS NULL
-- AND t2.industry IS NOT NULL;
-- select `date`,str_to_date(`date`,'%d/%m/%y') FROM layoff_staging2;
-- UPDATE layoff_staging2
-- SET `date` = STR_TO_DATE(`date`, '%m/%d/%Y')
...
-- or industry = "" ;
-- select * from layoff_staging2;
-- select * from  layoff_staging2 as t1 join  layoff_staging2 as t2 on t1.company = t2.company 
-- where ( t1.industry is null or t1.industry = "") and t2.industry is not null ;
-- update layoff_staging2 as t1 join layoff_staging2 as t2 
-- set t1.industry = t2.industry where (t1.industry is null or t1.industry= "") and (t2.industry is not null or t2.industry= "") ;
